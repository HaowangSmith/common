...
public class BaseException extends Exception {
    ...
    public static final int ERROR_ALREADY_REGISTER_407 = 407;
    public static final int ERROR_OLD_PWD_409 = 409;
    ...
    public BaseException(int code, String display_message) {
        this.code = code;
